#!/usr/bin/env bash
export EPS_BASE_URL=${EPS_BASE_URL:-https://raw.githubusercontent.com/bigantal/proxmox-scripts/refs/heads/main}
...
EPS_CT_HOSTNAME=${EPS_CT_HOSTNAME:-${EPS_APP_NAME}}-$(pvesh get /cluster/nextid)
